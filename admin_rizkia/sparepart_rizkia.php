...
if(isset($_POST['tambah_rizkia'])){
    $kode = mysqli_real_escape_string($conn_rizkia, $_POST['kode_part_rizkia']);
    $nama = mysqli_real_escape_string($conn_rizkia, $_POST['nama_part_rizkia']);
    $kategori = mysqli_real_escape_string($conn_rizkia, $_POST['kategori_rizkia']);
    $tipe = mysqli_real_escape_string($conn_rizkia, $_POST['tipe_motor_rizkia']);
    $satuan = mysqli_real_escape_string($conn_rizkia, $_POST['satuan_rizkia']);
    $grade = mysqli_real_escape_string($conn_rizkia, $_POST['grade_kualitas_rizkia']);

    mysqli_query($conn_rizkia, "INSERT INTO sparepart_master
    (kode_part_rizkia, nama_part_rizkia, kategori_rizkia, tipe_motor_rizkia, satuan_rizkia, grade_kualitas_rizkia)
    VALUES('$kode','$nama','$kategori','$tipe','$satuan','$grade')");
}
...
if(isset($_POST['update_rizkia'])){
    ...
    mysqli_query($conn_rizkia, "UPDATE sparepart_master SET
    kode_part_rizkia='$kode',
    nama_part_rizkia='$nama',
    kategori_rizkia='$kategori',
    tipe_motor_rizkia='$tipe',
    satuan_rizkia='$satuan',
    grade_kualitas_rizkia='$grade'
    WHERE id_rizkia='$id'");
}

if(isset($_POST['hapus_rizkia'])){
    $id = mysqli_real_escape_string($conn_rizkia, $_POST['id']);
    mysqli_query($conn_rizkia, "DELETE FROM sparepart_master WHERE id_rizkia='$id'");
}
?>
<!DOCTYPE html>
<html>
...
input{width:100%;padding:10px;margin-bottom:10px;border:1px solid #dcdde1;border-radius:10px}
...
<div class="content">
    ...
    <div class="card">
        ...
        <table>
            <tr><th>Kode</th><th>Nama</th><th>Kategori</th><th>Tipe Motor</th><th>Satuan</th><th>Grade</th><th>Aksi</th></tr>
